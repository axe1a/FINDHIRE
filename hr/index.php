...
<body>
	...
	<?php $getUserByID = getUserByID($pdo, $_SESSION['user_id']); ?>
		<form action="core/handleForms.php?user_id=<?php echo $_SESSION['user_id']; ?>" method="POST">
			<h3><?php echo $getUserByID['first_name'], " ", $getUserByID['last_name']; ?></h3>
			<p><?php echo $getUserByID['company']; ?></p>

			 
			<input type="text" name="post" placeholder="Write a job post">

			<input type="submit" name="insertJobPostBtn" value="Post">
