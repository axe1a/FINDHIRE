...
<div class="job-posts-container">
  <h2 class="job-posts-title">View Applications</h2><br><br>
  <div class="job-posts-list">
	<?php $getJobPostByUser = getJobPostByUser($pdo, $_SESSION['user_id']); ?>
	<?php foreach ($getJobPostByUser as $row) { ?>
    <div class="job-post-item">
	  ...
	  <hr style="color:#333">
      <a href="applications_list.php?post_id=<?php echo $row['post_id']; ?>" class="job-post-apply-link"> View Applications </a>
    </div>
    <?php } ?>
  </div>
</div>
